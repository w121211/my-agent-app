 ...
 */
type DeepPartial<T> = T extends z3.ZodTypeAny
  ? DeepPartialInternal<z3.infer<T>>
 ...
 */
declare const coreUserMessageSchema: z.ZodType<
  UserModelMessage,
  unknown,
  z.core.$ZodTypeInternals<UserModelMessage, unknown>
>;
/**
...
declare const coreAssistantMessageSchema: z.ZodType<
  AssistantModelMessage,
  unknown,
  z.core.$ZodTypeInternals<AssistantModelMessage, unknown>
>;
/**
 ...
 */
declare const coreToolMessageSchema: z.ZodType<
  ToolModelMessage,
  unknown,
  z.core.$ZodTypeInternals<ToolModelMessage, unknown>
>;
/**
...
declare function getToolName<TOOLS extends UITools>(
...
type InferUIMessageChunk<T extends UIMessage> = UIMessageChunk<
...
declare function generateObject<
  SCHEMA extends
    | z3.Schema
    | z4.core.$ZodType
    | Schema = z4.core.$ZodType<JSONValue$1>,
  OUTPUT extends
    | "object"
    | "array"
    | "enum"
 ...
 */
declare function consumeStream({
  stream,
  onError,
}: {
...
declare class JsonToSseTransformStream extends TransformStream<
  unknown,
  string
> {
  constructor();
...
type PrepareSendMessagesRequest<UI_MESSAGE extends UIMessage> = (
  options: {
    id: string;
    messages: UI_MESSAGE[];
...
declare abstract class HttpChatTransport<UI_MESSAGE extends UIMessage>
...
declare class TextStreamChatTransport<
  UI_MESSAGE extends UIMessage,
> extends HttpChatTransport<UI_MESSAGE> {
  constructor(options?: HttpChatTransportInitOptions<UI_MESSAGE>);
  protected processResponseStream(
...
export {
  ...
  AgentSettings as Experimental_AgentSettings,
