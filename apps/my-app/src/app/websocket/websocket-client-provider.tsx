...
// Props interface with required and optional properties
...
/**
 * Provider component that initializes EventBus and WebSocket client
 */
export const WebSocketEventClientProvider = ({
  ...
  // State for WebSocket client and EventBus
