...
async function runSubtaskExecutionExample(): Promise<void> {
  ...
  logger.info("2. CLIENT_START_NEW_CHAT_COMMAND - Create a chat for the subtask");
  logger.info("3. SERVER_CHAT_CREATED - Chat is created");
  logger.info("4. SERVER_SUBTASK_UPDATED - Subtask status changed to IN_PROGRESS");
  ...
  logger.info("7. SERVER_SUBTASK_UPDATED - Subtask status changed to COMPLETED");
